(function(name, definition) {
  ...
  return {
    routes: [{"uri":"_debugbar\/open","name":"debugbar.openhandler"},{"uri":"_debugbar\/assets\/stylesheets","name":"debugbar.assets.css"},{"uri":"_debugbar\/assets\/javascript","name":"debugbar.assets.js"},{"uri":"\/","name":"index"},{"uri":"user\/{summonerId}","name":"profile"},{"uri":"match\/{matchId}","name":"match"},{"uri":"tooltip","name":"tooltip"}],
